...
export const DashboardLayout = ({ children, navItems }: DashboardLayoutProps) => {
  ...
  return (
    <Box sx={{ display: 'flex', height: '100vh', backgroundColor: '#F5F7FA' }}>
        ...
        <Box sx={{ px: 3, py: 3, display: 'flex', alignItems: 'center', gap: 1.5 }}>
          <Box
            sx={{
              ...
              height: 36,
              borderRadius: '10px',
              background: 'linear-gradient(135deg, #0969DA, #085FC7)',
              display: 'flex',
              alignItems: 'center',
          ...
          <Box>
            ...
            <Typography sx={{ fontSize: '0.65rem', color: '#8494AB', letterSpacing: '0.08em', textTransform: 'uppercase', fontWeight: 600 }}>
              Platform
            </Typography>
          </Box>
        </Box>
          ...
          >
            ...
            <Tooltip title="Sign out" placement="top">
              <IconButton
                ...
                sx={{
                  color: '#8494AB',
                  '&:hover': { color: '#D92D20', backgroundColor: '#FEE4E2' },
                  flexShrink: 0,
                }}
              >
                <LogOut size={16} />
      ...
      >
        <Toolbar sx={{ justifyContent: 'space-between', minHeight: '60px !important', px: 4 }}>
          <Box>
            <Typography variant="h6" sx={{ fontWeight: 700, color: '#111827', lineHeight: 1.2, fontSize: '1rem' }}>
              {currentPage}
            </Typography>
            <Typography variant="caption" sx={{ color: '#8494AB', fontSize: '0.75rem' }}>
